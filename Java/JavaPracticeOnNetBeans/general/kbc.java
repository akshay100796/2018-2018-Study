                ...
                if(1==l1) 
                {
                    ...
                    if(ans[0]==ua0) 
                    {
                        ...
                        if(l2==1) 
                        {
                            ...
                            if(ans[1]==ua1) 
                            {
                                System.out.println("Congratulation...you won Rs. 1,00,00,000");
                                System.out.println("________________________________________");
            ...
            case 2:
            {
                ...
                switch(d)
                {
                    case 1:
                        ...
                        System.out.println("First  Question for Rs. 1,00,00,000 \n Lifeline is : Audiance pole");
                        System.out.println("Second Question for Rs. 1,00,00,000 (1 Lakh) \n Lifeline is : 50-50");
                        ...
                        System.out.println("Fifth  Question for Rs. 1,00,00,000 (1 Lakh) \n Lifeline is : Judge");
                        break;
                    case 2:
