package SwingOperation.src.FrameChange;
    ...
    public QuestionDisplay() throws Exception
    {
        ...
        submit.addActionListener((ActionEvent e) ->
        {
            ...
            if(Ques1A.isSelected())
            {
                Ans1 = Ques1A.getText();
                ch = 'A';
                if(q.ChAns[0] == ch){Correct[0] = Ans1;}
                else{Wrong[0] = Ans1;}
            }
           if(Ques1B.isSelected())
           {
               Ans1 = Ques1B.getText();
               if(Ans1 == q.ans[0]){Correct[0] = Ans1;}
               else{Wrong[0] = Ans1;}
           }
           ...
           if(Ques1D.isSelected())
           {
            ...
            {
                Ans2 = Ques2A.getText();
                if(Ans2 == q.ans[1]){Correct[1] = Ans2;}
                else{Wrong[1] = Ans2;}
            }
           ...
           if(Ques2D.isSelected())
           {
            ...
            {
                Ans3 = Ques3A.getText();
                if(Ans3 == q.ans[2]){Correct[2] = Ans3;}
                else{Wrong[2] = Ans3;}
            }
           ...
           //----------------------------------------Question 4
            ...
            {
                Ans4 = Ques4A.getText();
                if(Ans4 == q.ans[3]){Correct[3] = Ans4;}
                else{Wrong[3] = Ans4;}
            }
            ...
            {
                Ans5 = Ques5A.getText();
                if(Ans5 == q.ans[4]){Correct[4] = Ans5;}
                else{Wrong[4] = Ans5;}
            }
           ...
           if(Ques6A.isSelected())
            {
            Ans6 = Ques6A.getText();
            if(Ans6 == q.ans[5]){Correct[5] = Ans6;}
            else{Wrong[5] = Ans6;}
            }
           ...
           if(Ques7A.isSelected())
            {
                Ans7 = Ques7A.getText();
                if(Ans7 == q.ans[6]){Correct[6] = Ans7;}
                else{Wrong[6] = Ans7;}
            }
           ...
           if(Ques8A.isSelected())
            {
                Ans8 = Ques8A.getText();
                if(Ans8 == q.ans[7]){Correct[7] = Ans8;}
                else{Wrong[7] = Ans8;}
            }
            ...
            {
                Ans9 = Ques9A.getText();
                if(Ans9 == q.ans[8]){Correct[8] = Ans9;}
                else{Wrong[8] = Ans9;}
            }
            ...
            if(Ques10A.isSelected())
            {
                ...
                if(Ans10 == q.ans[9]){Correct[9] = Ans10;}
                else{Wrong[9] = Ans10;}
            }
            ...
            System.out.println("Ans 5 : "+Ans5);
            System.out.println("Ans 6 : "+Ans6);
            System.out.println("Ans 7 : "+Ans7);
            System.out.println("Ans 8 : "+Ans8);
            System.out.println("Ans 9 : "+Ans9);
            System.out.println("Ans 10: "+Ans10);
